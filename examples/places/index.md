...
Next, I treat the labels as terms in a dictionary, and use [cakes.nlp.dictionary](https://github.com/knoxa/cakes/tree/main/src/cakes/nlp/dictionary)
to apply the the dictionary to itself.
